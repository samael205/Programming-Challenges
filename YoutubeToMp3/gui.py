...
class Downloader(QtWidgets.QWidget):
    def __init__(self):
        ...
        tabs_icon = QtGui.QIcon("icons/tabs.png")
        links_icon = QtGui.QIcon("icons/url.png")
        history_icon = QtGui.QIcon("icons/history.png")
        download_icon = QtGui.QIcon("icons/download.png")
        back_icon = QtGui.QIcon("icons/back.png")
